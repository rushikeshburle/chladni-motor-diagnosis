  ...
  return (
    <div className="card hover:scale-105 hover:shadow-xl transition-all duration-300">
      <div className="flex items-center space-x-3 mb-4">
        ...
        <h2 className="text-xl font-bold font-heading text-[#0F172A]">Image Analysis</h2>
      </div>
      ...
      {!data ? (
        ...
        >
          ...
          <p className="text-sm text-gray-500 mb-4">Upload Chladni Pattern Image</p>
        ...
        <div className="space-y-4">
          ...
          <div className="glass-card p-4 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs text-gray-500">
              <div>Size: {(data.file_size / 1024).toFixed(1)} KB</div>
